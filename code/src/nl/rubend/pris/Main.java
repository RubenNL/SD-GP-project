...
public class Main extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		school.addGebruiker(new Student("a@bce", "a", "A", 234));
		school.addGebruiker(new Student("b@bce", "b", "B", 123));
		school.addGebruiker(new Systeembeheerder("b","","sysBeheerNaam"));
		school.addKlas(new Klas("TICT-SD-V1E"));
		school.getKlasByName("TICT-SD-V1E").addStudent((Student) school.getGebruikerByEmail("a@bce"));
		school.getKlasByName("TICT-SD-V1E").addStudent((Student) school.getGebruikerByEmail("b@bce"));
